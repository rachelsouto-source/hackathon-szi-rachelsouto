...
## R10 — Fonte e premissa do documento de terceiro

> Origem: revisão funcional de 29/07/2026. A primeira pergunta feita ao material do
> São Miguel dos Milagres não foi sobre o terreno — foi sobre a fonte do fornecedor:
> *"leia os documentos e me diga de onde ele está tirando a linha de marinha."*
> Resposta: nem a planta nem o relatório citavam. Foi o que destravou o caso.

Todo **dado técnico determinante** apresentado por documento de terceiro deve declarar
**a fonte** e **a premissa normativa** adotada.

**Documento sem fonte declarada é achado** — independentemente da qualidade da medição.

### Por que isto é a regra mais importante do conjunto

Medição correta sobre premissa errada é o modo de falha mais caro da DD, porque passa
por todos os outros controles. No 12235:

- o levantamento topográfico era **metricamente excelente** — 15 arestas conferidas com
  divergência máxima de 1,2 cm, área por Gauss batendo com a declarada em 0,13 m²;
- e mesmo assim a conclusão dominial estava errada, porque a prancha traçou a **"LPM
  atual"** (maré de hoje) quando a lei define terreno de marinha pela **preamar-média de
  1831** (DL 9.760/1946, art. 2º);
- resultado: ~80% do lote sob domínio da União, contra "não interceptado" na prancha.

Nenhuma checagem de consistência interna pegaria isso. Só a pergunta pela premissa pega.

### Como aplicar

Para cada dado determinante (área, linha de demarcação, cota, parâmetro urbanístico,
classificação de risco), perguntar:

1. **De onde veio?** Medição própria, base oficial, cadastro, outro documento, ou nada?
2. **Qual a premissa?** Data-base, norma de referência, datum, escala, revisão.
3. **A premissa é a que a lei exige?** — este é o passo que costuma faltar.
4. **A escala/plotagem confere?** Pranchas declaram uma escala e são plotadas em outra.
   Não medir sobre o PDF; a tabela de coordenadas é a fonte confiável.

### Severidade

Herda a severidade da afirmação que o documento sustenta. Se o dado sem fonte embasa um
achado crítico, a ausência de fonte é **crítica** — não é formalidade.

### Ação padrão

Exigir do fornecedor a fonte e a premissa normativa **por escrito**, antes de usar o dado
como base de decisão. Enquanto não vier, a afirmação apoiada nele é **indeterminada**,
não confirmada.
