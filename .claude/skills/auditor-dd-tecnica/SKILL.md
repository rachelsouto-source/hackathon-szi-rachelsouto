...
- Monte o **mapa de completude**: o que existe, o que falta. Veja
  `claude.md/references/dd-tecnica-playbook.md` para a lista canônica de documentos.
...
Aplique TODAS as regras de `claude.md/references/dd-tecnica-playbook.md`, em especial:
...
### 4. Gerar as saídas
- **Parecer**: use `claude.md/templates/parecer-tecnico.md`. Preencha IMÓVEL, PROPRIETÁRIO,
...
- **Planilha de controle**: use `claude.md/scripts/gerar_checklist.py` (ou o template
  `claude.md/templates/checklist-controle.csv`) para gerar o status por etapa.
...
- **Parametrizável por município**: a legislação/órgãos mudam fora de Floripa
  (ver `claude.md/references/legislacao-municipios.md`).
